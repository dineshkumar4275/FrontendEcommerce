...
//             </div>
//           </div>
//           <p className="text-gray-500 mt-4 font-medium">{t('loading_dashboard') || 'Loading dashboard...'}</p>
//         </div>
//       </div>
//     );
//   }
...
//                   <SparklesIcon className="w-4 h-4 text-white" />
//                 </div>
//                 <span className="text-sm font-semibold text-purple-600 uppercase tracking-wider">{t('dashboard') || 'Dashboard'}</span>
//               </div>
//               <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">{t('welcome_admin') || 'Welcome back, Admin'}</h1>
//               <p className="text-gray-500 mt-1">{t('dashboard_subtitle') || "Here's what's happening with Sombustore today."}</p>
//             </div>
//             <div className="flex items-center gap-3">
//               <div className="flex items-center gap-2 px-3 py-2 bg-white rounded-xl shadow-sm border border-gray-100">
//                 <ClockIcon className="w-4 h-4 text-gray-400" />
//                 <span className="text-xs text-gray-500">{t('last_updated') || 'Last updated'}: {lastUpdated.toLocaleTimeString()}</span>
//               </div>
//               <button
//                 onClick={fetchDashboardData}
//                 className="p-2 bg-white rounded-xl shadow-sm border border-gray-100 hover:bg-gray-50 transition-colors"
...
//                 <div className="flex justify-between items-start">
//                   <div>
//                     <p className="text-green-100 text-xs font-medium uppercase tracking-wider">{t('total_earnings') || 'Total Earnings'}</p>
//                     <p className="text-2xl sm:text-3xl font-bold mt-2">{formatCurrency(stats.summary.total_earnings)}</p>
//                     <p className="text-green-100 text-xs mt-1 flex items-center gap-1">
//                       <BoltIcon className="w-3 h-3" />
//                       {stats.summary.total_deliveries} {t('deliveries_completed') || 'deliveries completed'}
//                     </p>
//                   </div>
//                   <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
//                     <CurrencyRupeeIcon className="w-6 h-6" />
...
//                 <div className="flex justify-between items-start">
//                   <div>
//                     <p className="text-blue-100 text-xs font-medium uppercase tracking-wider">{t('today_earnings') || "Today's Earnings"}</p>
//                     <p className="text-2xl sm:text-3xl font-bold mt-2">{formatCurrency(stats.summary.today_earnings)}</p>
//                     <p className="text-blue-100 text-xs mt-1 flex items-center gap-1">
//                       <BoltIcon className="w-3 h-3" />
//                       {stats.summary.today_deliveries} {t('deliveries_today') || 'deliveries today'}
//                     </p>
//                   </div>
//                   <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
//                     <CalendarIcon className="w-6 h-6" />
...
//                 <div className="flex justify-between items-start">
//                   <div>
//                     <p className="text-purple-100 text-xs font-medium uppercase tracking-wider">{t('this_week') || 'This Week'}</p>
//                     <p className="text-2xl sm:text-3xl font-bold mt-2">{formatCurrency(stats.summary.week_earnings)}</p>
//                     <p className="text-purple-100 text-xs mt-1 flex items-center gap-1">
//                       <BoltIcon className="w-3 h-3" />
//                       {stats.summary.week_deliveries} {t('deliveries_this_week') || 'deliveries this week'}
//                     </p>
//                   </div>
//                   <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
//                     <ChartBarIcon className="w-6 h-6" />
...
//                 <div className="flex justify-between items-start">
//                   <div>
//                     <p className="text-orange-100 text-xs font-medium uppercase tracking-wider">{t('this_month') || 'This Month'}</p>
//                     <p className="text-2xl sm:text-3xl font-bold mt-2">{formatCurrency(stats.summary.month_earnings)}</p>
//                     <p className="text-orange-100 text-xs mt-1 flex items-center gap-1">
//                       <BoltIcon className="w-3 h-3" />
//                       {stats.summary.month_deliveries} {t('deliveries_this_month') || 'deliveries this month'}
//                     </p>
//                   </div>
//                   <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
//                     <ArrowTrendingUpIcon className="w-6 h-6" />
...
//                 </div>
//                 <div>
//                   <h3 className="font-semibold text-gray-800 text-lg">{t('pending_orders') || 'Pending Orders'}</h3>
//                   <p className="text-xs text-gray-500">{t('awaiting_driver') || 'Awaiting driver assignment'}</p>
//                 </div>
//               </div>
//               <p className="text-3xl font-bold text-yellow-600">{stats.summary.pending_orders}</p>
//             </div>
...
//                 </div>
//                 <div>
//                   <h3 className="font-semibold text-gray-800 text-lg">{t('in_progress') || 'In Progress'}</h3>
//                   <p className="text-xs text-gray-500">{t('orders_being_delivered') || 'Orders being delivered'}</p>
//                 </div>
//               </div>
//               <p className="text-3xl font-bold text-blue-600">{stats.summary.orders_in_progress}</p>
//             </div>
...
//                   </div>
//                   <div>
//                     <h2 className="font-semibold text-gray-800">{t('drivers_active_today') || 'Drivers Active Today'}</h2>
//                     <p className="text-xs text-gray-500">{t('drivers_who_completed') || "Drivers who completed deliveries"}</p>
//                   </div>
//                 </div>
//                 <div className="flex items-center gap-2">
//                   <span className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs px-3 py-1.5 rounded-full font-medium shadow-sm">
//                     {stats.drivers_today.length} {t('active_drivers') || 'Active Drivers'}
//                   </span>
//                 </div>
//               </div>
//             </div>
...
//                   <TruckIcon className="w-8 h-8 text-gray-300" />
//                 </div>
//                 <p className="text-gray-500">{t('no_active_drivers') || 'No active drivers at the moment'}</p>
//                 <p className="text-xs text-gray-400 mt-1">{t('drivers_appear_when_start') || "Drivers will appear here when they start deliveries"}</p>
//               </div>
//             ) : (
//               <>
//                 {/* Mobile Card View */}
...
//                               <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-700">
//                                 <BoltIcon className="w-2.5 h-2.5" />
//                                 {driver.deliveries_count} {t('deliveries') || 'deliveries'}
//                               </span>
//                               <span className="text-xs font-semibold text-green-600">
//                                 {formatCurrency(driver.earnings_today)}
//                               </span>
...
//                         <div className="text-right">
//                           <p className="text-xs text-gray-400">{driver.vehicle_number || 'No vehicle'}</p>
//                           <p className="text-xs text-gray-400 mt-1">{t('last') || 'Last'}: {formatDate(driver.last_delivery_time)}</p>
//                         </div>
//                       </div>
//                     </motion.div>
//                   ))}
...
//                     <thead className="bg-gray-50">
//                       <tr>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('driver') || 'Driver'}</th>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('contact') || 'Contact'}</th>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('vehicle') || 'Vehicle'}</th>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('performance') || 'Performance'}</th>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('last_delivery') || 'Last Delivery'}</th>
//                       </tr>
//                     </thead>
//                     <tbody className="divide-y divide-gray-100">
//                       {stats.drivers_today.map((driver, idx) => (
...
//                 </div>
//                 <div>
//                   <h2 className="font-semibold text-gray-800">{t('all_drivers_performance') || 'All Drivers Performance'}</h2>
//                   <p className="text-xs text-gray-500">{t('complete_driver_analytics') || 'Complete driver performance analytics'}</p>
//                 </div>
//               </div>
//             </div>
...
//                   <UserGroupIcon className="w-8 h-8 text-gray-300" />
//                 </div>
//                 <p className="text-gray-500">{t('no_drivers_found') || 'No drivers found'}</p>
//                 <p className="text-xs text-gray-400 mt-1">{t('add_drivers_to_see') || 'Add drivers to see performance data'}</p>
//               </div>
//             ) : (
//               <>
//                 {/* Mobile Card View */}
...
//                       <div className="grid grid-cols-2 gap-3 mt-3">
//                         <div className="bg-gray-50 rounded-lg p-2 text-center">
//                           <p className="text-xs text-gray-500">{t('total_deliveries') || 'Total Deliveries'}</p>
//                           <p className="text-lg font-bold text-gray-800">{driver.total_deliveries}</p>
//                         </div>
//                         <div className="bg-gray-50 rounded-lg p-2 text-center">
//                           <p className="text-xs text-gray-500">{t('total_earnings') || 'Total Earnings'}</p>
//                           <p className="text-lg font-bold text-purple-600">{formatCurrency(driver.total_earnings)}</p>
//                         </div>
//                         <div className="bg-gray-50 rounded-lg p-2 text-center">
//                           <p className="text-xs text-gray-500">{t('today') || 'Today'}</p>
//                           <p className="text-sm font-semibold text-gray-800">{driver.today_deliveries} {t('deliveries') || 'deliveries'}</p>
//                         </div>
//                         <div className="bg-gray-50 rounded-lg p-2 text-center">
//                           <p className="text-xs text-gray-500">{t('today_earnings') || 'Today Earnings'}</p>
//                           <p className="text-sm font-semibold text-green-600">{formatCurrency(driver.today_earnings)}</p>
//                         </div>
//                       </div>
//                     </motion.div>
...
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('total_deliveries') || 'Total Deliveries'}</th>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('total_earnings') || 'Total Earnings'}</th>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('today') || 'Today'}</th>
//                         <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('today_earnings') || 'Today Earnings'}</th>
//                       </tr>
//                     </thead>
//                     <tbody className="divide-y divide-gray-100">
//                       {stats.all_drivers.map((driver, idx) => (
...
//                             <div className="flex items-center gap-2">
//                               <span className="text-sm font-semibold text-gray-800">{driver.total_deliveries}</span>
//                               <span className="text-xs text-gray-400">{t('deliveries') || 'deliveries'}</span>
//                             </div>
//                           </td>
//                           <td className="px-6 py-4">
//                             <span className="text-sm font-semibold text-purple-600">{formatCurrency(driver.total_earnings)}</span>
...
//                   <div>
//                     <h3 className="text-xl font-bold">{selectedDriver.name}</h3>
//                     <p className="text-purple-100 text-sm">{t('driver_id') || 'Driver ID'}: #{selectedDriver.id}</p>
//                   </div>
//                 </div>
//               </div>
...
//                   </div>
//                   <div className="bg-gray-50 rounded-xl p-3">
//                     <p className="text-xs text-gray-500">{t('today_deliveries') || "Today's Deliveries"}</p>
//                     <p className="text-xl font-bold text-gray-800">{selectedDriver.today_deliveries}</p>
//                   </div>
//                   <div className="bg-gray-50 rounded-xl p-3">
//                     <p className="text-xs text-gray-500">{t('today_earnings') || "Today's Earnings"}</p>
//                     <p className="text-xl font-bold text-green-600">{formatCurrency(selectedDriver.today_earnings)}</p>
//                   </div>
//                 </div>
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setStats({
          ...
          driversToday: data.driversToday || [],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-purple-50/30">
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        {/* Stats Grid - FIXED: Using direct stats */}
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate="visible"
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-green-100 text-xs mt-1 flex items-center gap-1">
                      <BoltIcon className="w-3 h-3" />
                      {stats.totalOrders} {t('orders_completed') || 'orders completed'}
                    </p>
                  </div>
                  <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                    <CurrencyRupeeIcon className="w-6 h-6" />
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-blue-100 text-xs font-medium uppercase tracking-wider">{t('today_earnings') || "Today's Earnings"}</p>
                    <p className="text-2xl sm:text-3xl font-bold mt-2">{formatCurrency(stats.todayRevenue)}</p>
                    <p className="text-blue-100 text-xs mt-1 flex items-center gap-1">
                      <BoltIcon className="w-3 h-3" />
                      {stats.todayOrders} {t('orders_today') || 'orders today'}
                    </p>
                  </div>
                  <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                    <CalendarIcon className="w-6 h-6" />
          ...
          <motion.div variants={itemVariants} className="group">
            <div className="relative overflow-hidden bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-purple-100 text-xs font-medium uppercase tracking-wider">{t('total_orders') || 'Total Orders'}</p>
                    <p className="text-2xl sm:text-3xl font-bold mt-2">{stats.totalOrders}</p>
                    <p className="text-purple-100 text-xs mt-1 flex items-center gap-1">
                      <BoltIcon className="w-3 h-3" />
                      {stats.pendingOrders} {t('pending') || 'pending'}
                    </p>
                  </div>
                  <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
          ...
          <motion.div variants={itemVariants} className="group">
            <div className="relative overflow-hidden bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-orange-100 text-xs font-medium uppercase tracking-wider">{t('total_users') || 'Total Users'}</p>
                    <p className="text-2xl sm:text-3xl font-bold mt-2">{stats.totalUsers}</p>
                    <p className="text-orange-100 text-xs mt-1 flex items-center gap-1">
                      <BoltIcon className="w-3 h-3" />
                      {stats.totalDrivers} {t('drivers') || 'drivers'}
                    </p>
                  </div>
                  <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 border border-yellow-100 hover:shadow-md transition-all duration-300">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-lg">{t('pending_orders') || 'Pending Orders'}</h3>
                  <p className="text-xs text-gray-500">{t('awaiting_driver') || 'Awaiting processing'}</p>
                </div>
              </div>
            ...
            <div className="mt-4 h-2 bg-yellow-200 rounded-full overflow-hidden">
              <div 
                className="h-full bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full transition-all duration-500"
                style={{ width: `${Math.min((stats.pendingOrders / (stats.pendingOrders + stats.inProgressOrders || 1)) * 100, 100)}%` }}
              />
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100 hover:shadow-md transition-all duration-300">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 text-lg">{t('in_progress') || 'In Progress'}</h3>
                  <p className="text-xs text-gray-500">{t('orders_being_delivered') || 'Orders being processed'}</p>
                </div>
              </div>
            ...
            <div className="mt-4 h-2 bg-blue-200 rounded-full overflow-hidden">
              <div 
                className="h-full bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full transition-all duration-500"
                style={{ width: `${Math.min((stats.inProgressOrders / (stats.pendingOrders + stats.inProgressOrders || 1)) * 100, 100)}%` }}
              />
            </div>
          </div>
        </motion.div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300">
            <div className="px-5 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs px-3 py-1.5 rounded-full font-medium shadow-sm">
                    {stats.driversToday.length} {t('active_drivers') || 'Active Drivers'}
                  </span>
                </div>
              </div>
            </div>
            
            {stats.driversToday.length === 0 ? (
              <div className="text-center py-12">
                <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <TruckIcon className="w-8 h-8 text-gray-300" />
                </div>
              ...
              <>
                {/* Mobile Card View */}
                <div className="block md:hidden divide-y divide-gray-100">
                  {stats.driversToday.map((driver, idx) => (
                    <motion.div
                      key={driver.id}
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300">
            ...
            {stats.allDrivers.length === 0 ? (
              ...
              <>
                {/* Mobile Card View */}
                <div className="block md:hidden divide-y divide-gray-100">
                  {stats.allDrivers.map((driver, idx) => (
                    <motion.div
                      key={driver.id}
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
