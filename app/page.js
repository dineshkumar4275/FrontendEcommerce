  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black pt-20">
        ...
        {/* Features - Showing soon badges */}
        <div className="bg-gradient-to-b from-slate-900 to-slate-950 py-12">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">

              {[ 
                { icon: TruckIcon, title: "Free Shipping", desc: "On orders above ₹500", soon: false },
                { icon: ShieldCheckIcon, title: "Secure Payment", desc: "100% Secure", soon: false },
                { icon: ClockIcon, title: "24/7 Support", desc: "Dedicated team", soon: false },
                { icon: ArrowRightIcon, title: "Easy Returns", desc: "7 days return", soon: false }
              ].map((item, i) => (
                <div key={i} className="text-center relative">
                  {/* Soon badge on features if needed */}
                  {item.soon && (
                    <span className="absolute -top-2 right-4 text-[10px] bg-yellow-500/20 text-yellow-400 px-2 py-0.5 rounded-full">
                      Soon
                    </span>
                  )}
                  <div className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-3">
        ...
        {/* No Products Message instead of Featured Products */}
        <div className="container mx-auto px-4 py-16 bg-slate-950">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-slate-400 mb-2">
              We're currently curating the best collection for you.
            </p>
            
            <p className="text-slate-500 text-sm mb-8">
              Our store is under construction. Check back soon for amazing products!
            </p>
