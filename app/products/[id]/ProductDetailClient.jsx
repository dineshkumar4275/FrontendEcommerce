...
// export default function ProductDetailClient({ product: initialProduct, breadcrumbs, productId }) {
...
//       const colorObj = typeof firstColor === 'object' ? firstColor : { name: colorName, code: null, image: null };
...
//       );
//       setCurrentImage(matchingImage || productImages[0] || product?.image_url);
//     }
//   };
...
//     const colorMap = {
//       Red: '#ef4444', Blue: '#3b82f6', Black: '#1f2937', White: '#ffffff',
//       Gold: '#fbbf24', Silver: '#9ca3af', Green: '#22c55e', Purple: '#9333ea',
//       Pink: '#ec4899', Yellow: '#eab308', Orange: '#f97316', Brown: '#78350f', Gray: '#6b7280',
//     };
...
//   const comparePriceValue = product?.compare_price ? (typeof product.compare_price === 'number' ? product.compare_price : parseFloat(product.compare_price) || 0) : 0;
//   const discountPercent = comparePriceValue > productPrice ? Math.round(((comparePriceValue - productPrice) / comparePriceValue) * 100) : 0;
...
//           {/* Coming Soon Banner */}
//           <div className="mb-6 bg-gradient-to-r from-yellow-500 via-orange-500 to-pink-500 rounded-2xl p-4 text-center shadow-lg">
...
//                     activeTab === tab.id ? 'text-purple-600 border-b-2 border-purple-600' : 'text-gray-500 hover:text-purple-600'
//                   }`}
//                 >
//                   {tab.label}
//                 </button>
...
//                 <div className="prose max-w-none"><p className="text-gray-600">{product.description || 'No description available.'}</p></div>
//               )}
...
//                     </div>
//                   </div>
//                   <button className="mt-6 px-6 py-2 border border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition">Write a Review</button>
//                 </div>
//               )}
//               {activeTab === 'shipping' && (
//                 <div className="space-y-4">
//                   <div><h3 className="font-semibold text-gray-800 mb-2">Shipping Information</h3><p className="text-gray-600">Free standard shipping on all orders above ₹500. Delivery typically takes 3-5 business days.</p></div>
//                   <div><h3 className="font-semibold text-gray-800 mb-2">Return Policy</h3><p className="text-gray-600">Easy returns within 7 days of delivery. Items must be unused and in original packaging.</p></div>
//                 </div>
//               )}
//             </div>
//           </div>
