...
// //         toast.success(`📍 ${locData.street || locData.city || 'Location'} found`);
// //       } else {
...
// //         updateCurrenciesAndLanguages(data.data);
// //         localStorage.setItem('userLocation', JSON.stringify(data.data));
// //         toast.success(`📍 ${data.data.city || 'Location'} detected`);
// //       } else {
...
// //     setLocation({
// //       ...location,
// //       street: result.address?.street || result.displayName.split(',')[0],
...
// //     setSearchQuery('');
// //     setSearchResults([]);
// //     toast.success(`📍 Location updated to ${result.displayName.split(',')[0]}`);
// //   };
...
// //     return location.street || location.city || location.formattedAddress || 'Unknown Location';
// //   };
...
// //         <span className="text-sm text-purple-300">Detecting...</span>
...
// //           className="ml-2 px-2 py-1 text-xs bg-red-500/20 text-red-300 rounded hover:bg-red-500/30 transition"
// //         >
// //           Retry
// //         </button>
// //       </div>
...
// //       {/* ✅ Main Button - Clean design without emoji */}
// //       <button
// //         onClick={() => setShowDropdown(!showDropdown)}
// //         className="flex items-center gap-2 px-3 py-2 bg-purple-500/10 rounded-lg border border-purple-500/20 hover:border-purple-500/40 transition-all hover:bg-purple-500/15 group"
// //       >
// //         <MapPinIcon className="w-4 h-4 text-purple-400 group-hover:text-purple-300" />
// //         <div className="text-left min-w-0">
// //           <div className="text-xs text-purple-400/70">Delivering to</div>
// //           <div className="text-sm font-semibold text-purple-200 truncate max-w-[120px] sm:max-w-[180px]">
// //             {getStreetName()}
// //           </div>
// //         </div>
// //         <ChevronDownIcon className={`w-3 h-3 text-purple-400 transition-transform ${showDropdown ? 'rotate-180' : ''}`} />
// //       </button>

// //       {/* ✅ Dropdown */}
// //       {showDropdown && (
// //         <div className="absolute right-0 mt-2 w-[380px] sm:w-[440px] bg-slate-800 rounded-2xl shadow-2xl border border-purple-500/30 z-50 overflow-hidden">
// //           {/* Header - No emoji */}
// //           <div className="px-4 py-3 bg-gradient-to-r from-purple-500/20 to-fuchsia-500/20 border-b border-purple-500/30 flex items-center justify-between">
// //             <div className="flex items-center gap-2">
// //               <MapPinSolid className="w-4 h-4 text-purple-400" />
// //               <h3 className="text-sm font-bold text-purple-200">Your Location</h3>
// //             </div>
// //             <button
// //               onClick={detectLocation}
// //               className="flex items-center gap-1 text-xs text-purple-400 hover:text-purple-200 transition"
// //             >
...
// //                         <p className="text-sm font-semibold text-purple-200">{getStreetName()}</p>
// //                         <p className="text-xs text-purple-400 truncate">{getCityState()}</p>
// //                         {location.fullAddress && (
// //                           <p className="text-xs text-purple-400/60 truncate mt-0.5">{location.fullAddress}</p>
// //                         )}
...
// //                     <MagnifyingGlassIcon className="absolute left-3 top-2.5 w-4 h-4 text-purple-400/50" />
// //                     <input
// //                       type="text"
...
// //                       <button
// //                         onClick={clearSearch}
// //                         className="absolute right-3 top-2.5 text-purple-400/50 hover:text-purple-300 transition"
// //                       >
...
// //                         className="w-full px-4 py-2 text-left hover:bg-purple-500/10 transition flex items-start gap-3"
// //                       >
// //                         <MapPinIcon className="w-4 h-4 text-purple-400 flex-shrink-0 mt-0.5" />
// //                         <div className="min-w-0">
// //                           <p className="text-sm text-purple-200 truncate">
// //                             {result.address?.street || result.displayName.split(',')[0] || 'Unknown'}
// //                           </p>
// //                           <p className="text-xs text-purple-400 truncate">
// //                             {result.address?.city || result.address?.state || result.address?.country || result.displayName}
// //                           </p>
// //                         </div>
// //                       </button>
// //                     ))}
...
// //                     <MapPinIcon className="w-8 h-8 text-purple-400/30 mx-auto mb-2" />
// //                     <p className="text-sm text-purple-400">No locations found</p>
// //                     <p className="text-xs text-purple-400/60 mt-1">Try a different search term</p>
// //                   </div>
// //                 )}

// //                 {/* Actions - No emoji */}
// //                 <div className="px-3 py-2 border-t border-purple-500/20 bg-slate-800/50 flex gap-2">
// //                   <button
// //                     onClick={detectLocation}
// //                     className="flex-1 flex items-center justify-center gap-1.5 text-center text-xs text-purple-400 hover:text-purple-200 transition py-1.5 px-2 bg-purple-500/10 rounded-lg"
// //                   >
// //                     <ArrowPathIcon className="w-3 h-3" />
// //                     Auto-detect
// //                   </button>
...
// //             {/* Currency Tab - No emoji */}
// //             {activeTab === 'currency' && (
// //               <div className="p-3">
// //                 <p className="text-xs text-purple-400/70 mb-3">Select your preferred currency</p>
...
// //                       {selectedCurrency?.code === currency.code && (
// //                         <span className="ml-auto text-xs text-purple-300">✓</span>
// //                       )}
// //                     </button>
// //                   ))}
// //                 </div>
...
// //             {/* Language Tab - No emoji */}
// //             {activeTab === 'language' && (
// //               <div className="p-3">
// //                 <p className="text-xs text-purple-400/70 mb-3">Select your preferred language</p>
// //                 <div className="grid grid-cols-2 gap-2">
...
// //             className="w-full py-2 text-xs text-purple-400 hover:bg-slate-700/50 transition border-t border-purple-500/20"
// //           >
...
//             const streetName = locData.street || locData.city || 'Location';
//             // toast.success(`📍 ${streetName} found`);
//             setToastShown(true);
//             setLocationSet(true);
//           }
//         }
...
//           if (!toastShown && !locationSet) {
//             const cityName = data.data.city || 'Location';
//             toast.success(`📍 ${cityName} detected`);
//             setToastShown(true);
//             setLocationSet(true);
//           }
//         }
...
//     toast.success(`📍 ${result.displayName.split(',')[0]} selected`);
//   };
...
//   // ✅ Toggle dropdown with mobile optimization
...
//                       <p className="text-[10px] sm:text-xs text-purple-400/60 mt-1">Try a different search term</p>
//                     </div>
//                   )}
