...
export const Header = ({ 
  ...
  return (
    <>
      <header key={`header-${language}-${forceUpdate}`} className={`fixed top-0 w-full z-40 transition-all duration-500 ${
        isScrolled 
          ? 'shadow-lg' 
          : ''
      }`}>
        
        {/* ✅ MOBILE VIEW - Amazon Style (hidden on large screens) */}
        <div className="lg:hidden bg-[#131921] border-b border-[#3a4553]">
          <div className="px-2 py-1.5">
            {/* First Row - Logo, Location, Icons */}
        ...
        {/* ✅ DESKTOP VIEW - Your Original Modern Style (hidden on mobile) */}
        <div className="hidden lg:block bg-white/95 backdrop-blur-xl border-b border-gray-100">
          <div className="container mx-auto px-6 lg:px-8">
            <div className="flex items-center justify-between h-20 gap-2">

              {/* Logo */}
              <Link href="/" className="flex items-center gap-2 flex-shrink-0 group">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/20 group-hover:shadow-purple-500/40 transition-all duration-300 group-hover:scale-105">
                ...
                <div>
                  ...
                  <span className="text-xs text-gray-400 font-medium ml-1">Store</span>
                </div>
              </Link>
              ...
              <div className="flex items-center gap-3">
                ...
                {isAdmin && (
                  <Link
                    href="/admin/dashboard"
                    className="p-2.5 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 rounded-xl transition-all duration-300 relative group"
                    title={t('admin_dashboard')}
                  >
                ...
                <button
                  ...
                  className="relative p-2.5 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 rounded-xl transition-all duration-300 group"
                >
                  <ShoppingCartIcon className="w-6 h-6 text-gray-600 group-hover:text-purple-600 transition-colors" />
                  {totalQuantity > 0 && (
                ...
                {isLoggedIn ? (
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDownIcon className={`w-3.5 h-3.5 text-gray-400 transition-transform duration-300 ${isUserMenuOpen ? 'rotate-180' : ''}`} />
                    </button>
      ...
      <div className="h-[100px] xs:h-[112px] lg:h-20"></div>
    </>
  );
};